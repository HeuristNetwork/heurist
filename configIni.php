...
$version = "5.0.4"; // sets current program version number, determined by Heurist development lead

// h5.0.4 Minor fixes, CSV output, dashbpard creation, icon directories etc.
