...
$version = "6.1.2"; // sets current program version number, determined by Heurist development lead

// dates below are the date of release of the given version, and list changes since last release

// h6.1.2 7 Jan 2021 Bug fixing, new display mode for continuous details result lists
