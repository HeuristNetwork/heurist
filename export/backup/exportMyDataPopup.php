...
<html>
    <head>
        <title>My Profile. Export My Data</title>
...
?>
        ...
        <p>Your data will be exported either as a fully self-documenting HML (Heurist XML) file without attached files
            (image files, video, XML, maps, documents etc.) or complete with attached files. </P>
		...
		<form name='f1' action='exportMyDataPopup.php' method='get'>
	        ...
	        <div class="input-row">
	            <div class="input-header-cell">Include attached files</div> <!--  (output everything as one ZIP file) -->
