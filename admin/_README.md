...
This directory contains all the administrative interface code from Heurist Vsn 3, also used by Heurist Vsn 4 and 5.
...
(No files directly in this directory other than this _README.md)
