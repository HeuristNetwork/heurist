...
CREATE TABLE Records (
  ...
  rec_AddedByImport tinyint unsigned NOT NULL default '0' COMMENT 'Whether added by an import (value 1) or by manual entry (value 0) - not sure this is set reliably',
  rec_Popularity int unsigned NOT NULL default '0' COMMENT 'Calculated popularity rating for sorting order, set by cron job - probably deprecated use',
  rec_FlagTemporary tinyint unsigned NOT NULL default '0' COMMENT 'Flags a partially created record before fully populated',
  rec_OwnerUGrpID smallint unsigned NOT NULL default '0' COMMENT 'Person or Workgroup which owns this record, 0 = everyone',
