# Directory: /admin/setup/dboperations

## Overview

This directory contains scripts for various database operations, including daily maintenance (cron jobs), database deletion, resetting demo databases, and managing welcome/notification emails.
