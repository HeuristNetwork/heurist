...
) ENGINE=InnoDB AUTO_INCREMENT=929 DEFAULT CHARSET=utf8 COMMENT='Map the codes used in this Heurist DB to codes used in other';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `defDetailTypes` (
  ...
  ) ENGINE=InnoDB AUTO_INCREMENT=809 DEFAULT CHARSET=utf8 COMMENT='The detail types (fields) which can be attached to records';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=2769 DEFAULT CHARSET=utf8 COMMENT='The record details (fields) required for each record type';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Grouping mechanism for record types in pulldowns';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8 COMMENT='Defines record types, which corresponds with a set of detail';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `defRelationshipConstraints` (
  ...
  ) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Constrain target-rectype/vocabularies/values for a pointer d';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=3758 DEFAULT CHARSET=utf8 COMMENT='Terms by detail type and the vocabulary they belong to';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=1960 DEFAULT CHARSET=utf8 COMMENT='Users/Groups diff. by ugr_Type. May defer to similar table i';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=4383 DEFAULT CHARSET=utf8 COMMENT='Identifies groups to which a user belongs and their role in ';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=124028 DEFAULT CHARSET=utf8 COMMENT='Personal and user group tags (formerly keywords)';
SET character_set_client = @saved_cs_client;
