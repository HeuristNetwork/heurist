...
--
-- Host: localhost
-- Generation Time: Feb 17, 2011 at 06:48 PM
-- Server version: 5.0.51
-- PHP Version: 5.2.3
--
-- Database: 'hdb_sandpit3'
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=144111 ;
...
CREATE TABLE defCalcFunctions (
  ...
  PRIMARY KEY  (cfn_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Specifications for generating calculated fields, plugins and' AUTO_INCREMENT=1 ;
...
CREATE TABLE defCrosswalk (
  ...
  crw_SourceCode smallint(5) unsigned NOT NULL COMMENT 'The code of the definition in the source database',
  ...
  crw_LocalCode smallint(5) unsigned NOT NULL COMMENT 'The corresponding code in the local database',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Map the codes used in this Heurist DB to codes used in other' AUTO_INCREMENT=1 ;
...
CREATE TABLE defDetailTypeGroups (
  ...
  PRIMARY KEY  (dtg_ID)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Groups detail types for display in separate sections of edit' AUTO_INCREMENT=7 ;
...
CREATE TABLE defDetailTypes (
  ...
  dty_Documentation varchar(5000) default 'Please document the nature of thsi detail type (field)) ...' COMMENT 'Documentation of the detail type, what it means, how defined',
  ...
  dty_OriginatingDBID smallint(5) unsigned default NULL COMMENT 'Database where this detail type originated, 0 = locally',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The detail types (fields) which can be attached to records' AUTO_INCREMENT=716 ;
...
CREATE TABLE defOntologies (
  ...
  ont_OriginatingDBID smallint(5) unsigned default NULL COMMENT 'Database where this ontology originated, 0 = locally',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='A table of references to different ontologies used by Heuris' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The record details (fields) required for each record type' AUTO_INCREMENT=2511 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Grouping mechanism for record types in pulldowns' AUTO_INCREMENT=7 ;
...
CREATE TABLE defRecTypes (
  ...
  rty_OriginatingDBID smallint(5) unsigned default NULL COMMENT 'Database where this record type originated, 0 = locally',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Defines record types, which corresponds with a set of detail' AUTO_INCREMENT=210 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Translation table into multiple languages for all translatab' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The detail (field) values for each record - public data' AUTO_INCREMENT=430144 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Threaded comments for each record' AUTO_INCREMENT=863 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Index to uploaded files linked from records' AUTO_INCREMENT=3895 ;
...
CREATE TABLE sysArchive (
  ...
  arc_DataBeforeChange blob COMMENT 'A representation of the data in the MySQL record before the mod',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='An archive of all (or most) changes in the database to allow' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Users/Groups diff. by ugr_Type. May defer to similar table i' AUTO_INCREMENT=1914 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Identifies groups to which a user belongs and their role in ' AUTO_INCREMENT=4335 ;

-- --------------------------------------------------------

--
-- Table structure for table 'sys_DBNameCache'
--

CREATE TABLE sys_DBNameCache (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Bookmark = personal data relating to a record, one for each ' AUTO_INCREMENT=142349 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Link table connecting tags to records' AUTO_INCREMENT=203402 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Reminders attached to records and recipients, with start dat' AUTO_INCREMENT=382 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Saved searches for personal/usergroup use and for publishing' AUTO_INCREMENT=6538 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Personal and user group tags (formerly keywords)' AUTO_INCREMENT=122929 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9206 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Woot records (entries, pages) are linked to a set of XHTML c' AUTO_INCREMENT=2985 ;
