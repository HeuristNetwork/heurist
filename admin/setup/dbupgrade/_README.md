...
- `DBUpgrade_1.3.0_to_1.3.14.php`: PHP script for upgrading database schema from version 1.3.0 to 1.3.14 (and potentially up to 1.3.19), including table modifications and additions.
