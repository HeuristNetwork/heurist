	        ...
	        <div id="page-inner">
			    ...
			    <div id="tb_top" style="height:30">
				    ...
				    <div id="pnlCtrlSel1"  class="selection" style="float:right; text-align:right;padding-top:5px;">
					    ...
					    <input type="button" tabindex="12" value="Cancel" onClick="selectManager.cancel();" />
					    <input type="button" tabindex="11" id="btnApply1" value="Add Users to Group" onClick="selectManager.returnSelection();" />
				    </div>
			    </div>
			    ...
			    <div id="tabContainer">
				    ...
				    function createManagerObj(){
					    selectManager = new  SelectManager(false, true, true); //nonfilter, selection, in window
				    }
			    ...
			    <div id="tb_top" style="height:30">
				    ...
				    <div id="pnlCtrlSel1"  class="selection" style="float:right; text-align:right;padding-top:5px;">
					    <label id="lblSelect1"></label>
					    <input type="button" tabindex="12" value="Cancel" onClick="selectManager.cancel();" />
					    <input type="button" tabindex="11" id="btnApply2" value="Add Users to Group" onClick="selectManager.returnSelection();" />
				    </div>
			    </div>
            </div>
	    </div>
