...
/* In theory a good idea, but ReCaptcha is sloooow, and this test is not working (see notes below).
    In practice, all requests go for authorisation so adnmin will soon know if the database is being spammed
    so this will do for the moment.
   Replace with a simple challenge such as 'to prove you are human, what is the capital of Fr-an-ce'
    if ($_REQUEST['register']) {
        ...
        // Why does the following line contain a test of the actual error string, this makes no sense
        //even with this removed - which is the way it was which worked in Vsn 2 - it still doesn't work
...
";
				...
				header('Location: '. HEURIST_URL_BASE.'admin/ugrps/msgRegistrationSuccess.html?db='.HEURIST_DBNAME.'&prefix='.HEURIST_DB_PREFIX);
			}
