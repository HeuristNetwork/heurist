...
$replacements = array("?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?"," ","?","?","?","?","?");
$textDetails = array();
$res = mysql_query("SELECT rd_id,rd_rec_id,rd_val,dty_Name ".
					"FROM rec_details left join defDetailTypes on rd_type = dty_ID  ".
					"WHERE dty_Type in ('freetext','blocktext') ORDER BY rd_rec_id");
