...
*
* TODO: This largely duplicates similar funciton in listDatabaseErrors.php
* fixing of the errors shoudl be automated, with an email to development team so we are aware of problem
*
* @author      Tom Murtagh
* @author      Kim Jackson
