<?php
/**
* fileLinkingErrors.php: runs through all databases on the server 
*   looking for uploaded file records with invalid target (missing directory or file).
*   todo: extend to also look for bad URL targets and uploaded file records which are never referenced.
*
...
<html>
    <head>
        ...
        <title>File Linking Errors</title>
    ...
    <body class="popup yui-skin-sam">
        <div id="titleBanner" class="banner"><h2>File Linking Errors</h2></div>
        <div id="page-inner">
