<?php
   ...
   // Edit defTerma table
    ...
    if (! is_admin()) {
        print "<html><body><p>You must be a system adminstrator to edit terms</p><p><a href='".HEURIST_URL_BASE."common/connect/login.php?logout=1&amp;db=".HEURIST_DBNAME."'>Log out</a></p></body></html>";
        return;
    }
...
$scheme = '';
$fielddef = array(
    'f0' => array(FLD_ID => true, FLD_VISIBLE => true, FLD_DISPLAY => 'trm_ID', FLD_DISPLAY_SZ => 7,
        ...
        FLD_DATABASE => 'trm_ID'),
    'f1' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'trm_Label', FLD_DISPLAY_SZ => 40,
        ...
        FLD_DATABASE => 'trm_Label'),
    'f2' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'trm_InverseTermId', FLD_DISPLAY_SZ => 7,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 7, FLD_INPUT_MAXLEN => 10, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => false, FLD_INPUT_VALIDATION => 'Numeric',
        FLD_DATABASE => 'trm_InverseTermId'),
    'f3' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Ontology ID (from defOntologieses table)', FLD_DISPLAY_SZ => 7,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 7, FLD_INPUT_MAXLEN => 5, FLD_INPUT_DFLT => '0',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => 'Numeric',
        FLD_DATABASE => 'trm_OntID'),
    'f4' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'trm_Description', FLD_DISPLAY_SZ => 60,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 60, FLD_INPUT_MAXLEN => 501, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => false, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'trm_Description'),
    'f5' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Status (Reserved, Approved, Pending, Open)', FLD_DISPLAY_SZ => 10,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 10, FLD_INPUT_MAXLEN => 9, FLD_INPUT_DFLT => 'Open',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'trm_Status'),
    
    // these fields not visible/editable
    'f6' => array(FLD_ID => false, FLD_VISIBLE => false, FLD_DISPLAY => '', FLD_DISPLAY_SZ => 7,
        FLD_INPUT => false, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 7, FLD_INPUT_MAXLEN => 5, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => 'Numeric',
        FLD_DATABASE => 'trm_OriginatingDBID'),
    'f7' => array(FLD_ID => false, FLD_VISIBLE => false, FLD_DISPLAY => '', FLD_DISPLAY_SZ => 7,
        FLD_INPUT => false, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 7, FLD_INPUT_MAXLEN => 5, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => 'Numeric',
        FLD_DATABASE => 'trm_IsLocalExtension'),
    'f8' => array(FLD_ID => false, FLD_VISIBLE => false, FLD_DISPLAY => '', FLD_DISPLAY_SZ => 99,
        FLD_INPUT => false, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 99, FLD_INPUT_MAXLEN => 64, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'trm_NameInOriginatingDB'),
    'f9' => array(FLD_ID => false, FLD_VISIBLE => false, FLD_DISPLAY => '', FLD_DISPLAY_SZ => 7,
        FLD_INPUT => false, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 7, FLD_INPUT_MAXLEN => 5, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => 'Numeric',
        FLD_DATABASE => 'trm_IDInOriginatingDB')
);
...
<html><head>
<title>Heurist enumerated value terma editing</title>
...
<?php
        ...
        echo "<h3>Heurist enumerated value terms for db = " . HEURIST_DBNAME ."</h3>";  
?>
