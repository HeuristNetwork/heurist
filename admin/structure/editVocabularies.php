<?php
    ...
    if (! is_admin()) {
        print "<html><body><p>You must be a system adminstrator to edit vocabularies</p><p><a href='".HEURIST_URL_BASE."common/connect/login.php?logout=1&amp;instance=".HEURIST_INSTANCE."'>Log out</a></p></body></html>";
        return;
    }
