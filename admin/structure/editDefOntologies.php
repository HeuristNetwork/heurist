...
$scheme = '';
$fielddef = array(
    'f0' => array(FLD_ID => true, FLD_VISIBLE => true, FLD_DISPLAY => 'Ontology ID', FLD_DISPLAY_SZ => 7,
        ...
        FLD_DATABASE => 'ont_ID'),
    'f1' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Concise name for ontology', FLD_DISPLAY_SZ => 100,
        ...
        FLD_DATABASE => 'ont_ShortName'),
    'f2' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Extended name for ontology', FLD_DISPLAY_SZ => 100,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 100, FLD_INPUT_MAXLEN => 385, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'ont_FullName'),
    'f3' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'Extended description of the ontology', FLD_DISPLAY_SZ => 100,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 100, FLD_INPUT_MAXLEN => 1000, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => true, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'ont_Description'),
    'f4' => array(FLD_ID => false, FLD_VISIBLE => true, FLD_DISPLAY => 'URI reference to the ontology', FLD_DISPLAY_SZ => 100,
        FLD_INPUT => true, FLD_INPUT_TYPE => 'text',
        FLD_INPUT_SZ => 100, FLD_INPUT_MAXLEN => 751, FLD_INPUT_DFLT => '',
        FLD_INPUT_NOTEMPTY => false, FLD_INPUT_VALIDATION => '',
        FLD_DATABASE => 'ont_RefURI')
);
