...
echo "start" >> /srv/BACKUP/ARCHIVE/__archive_file_deletions_log.txt
...
echo "Multiple copy cleanup completed $(date +'%d-%m-%Y %H:%M:%S')" >> /srv/BACKUP/ARCHIVE/__archive_file_deletions_log.txt
