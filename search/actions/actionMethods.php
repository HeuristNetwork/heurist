...
/**
* add_detail : adds a field value (detail) to the resultset or to all records of a particular type
*
* @param mixed $data
*/
...
/**
* replace_detail : replaces a specific field value (detail) with another in the resultset or to all records of a particular type
*
* @param mixed $data
*/
...
/**
* delete_detail : deletes a specific field value (detail) from the resultset or from all records of a particular type
*
* @param mixed $data
*/
...
/**
* delete_bookmarks : delete bookmarks from the current set of selected records
*
* @param mixed $data
*/
...
/**
* add_tags : add personal tags to the current set of selected records
*
* @param mixed $data
*/
...
/**
* add_wgTags : add workgroup tags to the current set of selected records
*
* @param mixed $data
*/
...
/**
remove_wgTags : remove workgroup tags from the current set of selected records
*
* @param mixed $data
*/
...
/**
* remove_Tags : remove personal tags from the current set of selected records
*
* @param mixed $data
*/
...
/**
* set_ratings : add personal ratings (0 - 5 stars) to the current set of selected records
*
* @param mixed $data
*/
...
/**
* bookmark_references : add bookmarks to the current set of selected records
*
* @param mixed $data
*/
...
/**
* bookmark_and_tag_record_ids : add bookmarks and then tag the current set of selected records
*
* @param mixed $data
*/
...
/**
* record_filter: return array of only the rec_ids that exist and the user has access to (workgroup filtered)
*
* @param $rec_ids
*/
...
/**
* get_ids_for_tags: return array of record IDS which have the specified set of tags
*
