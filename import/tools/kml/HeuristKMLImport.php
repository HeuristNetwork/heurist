...
*/
	...
	function getReferenceTypes() {
		...
		HeuristKMLParser::$_referenceTypes = mysql__select_assoc("active_rec_types left join rec_types on rt_id=art_id", "rt_name", "rt_id", "rt_id order by !rt_primary, rt_name");
