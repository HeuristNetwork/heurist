<?php
/**
* importHyperlinks.php - A form to import hyperlinks
* 
* Handles a form to import hyperlinks. Is allows users to analyze a webpage or file, select links, and bookmark them in Heurist.
* 
