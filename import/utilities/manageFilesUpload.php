...
<![endif]-->    
    ...
    <body class="popup">
        ...
        <?php
            ...
            print "<p>This function allows members of the database managers group to upload multiple files and/or large files to the database scratch space<br>";
            ...
            if(!array_key_exists('mode', $_REQUEST)) {
                ...
                if (!$res1 || mysql_num_rows($res1) == 0) {
                    die ("<p><b>Sorry, unable to read the sysIdentification table from the current databsae. Possibly wrong database format, please consult Heurist team</b></p>");
                }
                ...
                if ($mediaFolders=="" || count($dirs) == 1) {
                    print ("<p><b>If you wish to upload files to a directory other than the scratch space, define the folders in <br />".
                        "Designer View > Database > Advanced Properties > Additional Folders for indexing.<br />You may also add additional file extensions.</b></p>");
                }else{
            ...
            //$upload_folder = $dirs[0];
            //HEURIST_DOCUMENT_ROOT
            //HEURIST_UPLOAD_ROOT  + HEURIST_FILESTORE         (HEURIST_URL_BASE_UPLOAD_DIR)
            //HEURIST_UPLOAD_DIR   + dbname
            
            // HEURIST_SERVER_URL . $DIR_FILESTORE . $dbName
