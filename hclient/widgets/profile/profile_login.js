...
*/
        ...
        window.hWin.HAPI4.baseURL+'hserver/controller/saml.php?a=login&sp='+sp_entity+'&db='+window.hWin.HAPI4.database,
        {
...
function setupCaptcha($dlg){
    ...
    $ele.load(window.hWin.HAPI4.baseURL+'hserver/utilities/captcha.php?id='+id, function(e){
        // add input
