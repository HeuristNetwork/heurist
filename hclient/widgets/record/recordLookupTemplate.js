/**
* recordLookupTemplate.js 
* 
*  1) This file loads html content from recordLookupTemplate.html - define this file with controls as you wish
...
$.widget( "heurist.recordLookupTemplate", $.heurist.recordAction, {
    ...
    options: {
        ...
        htmlContent: 'recordLookupTemplate.html',
    ...
    _initControls: function(){
        ...
        */        
        ...
        // ------------------------------------------
        // In this case list of all Parisian keywords (vocab 6953) to allow decoding of the IDs 
        // and choice from eg. a dropdown. 
        // Look up the local ID for the vocab you wish to use in the vocabulary tree of your database 
        // If the vocab is a standard one defined in the default setup of new databases, 
        // this piece of code can work on any database.
        ...
        // ---------------------------------------
        // reading in all Project Keyword records (type 56) to build a session array 
        // of all the Project Keywords (Record ID + Title)
        // reading in all the Work records (type 55) and associated Parisian Keyword ID 
        // and Project Keyword Record IDs. (illustrates how to get values for a terms field)
        // Find record IDs for your database from the record type editor
        ...
        // -------------------------------
        // In this case to add Project Keywords. Parisian keywords are a fixed list of terms 
        // so they are simply selected from the list in memory.
    ...
    _doLookup: function(){
        ...
        var popup_options = {
            ...
            pointer_mode: null, // default behaviour = both, can be set to addonly  or browseonly
    ...
    _addNewRecord: function(isDirectAddition){
        ...
        var new_rec_data = {ID:0, RecTypeID:56, 
            no_validation:true, // allows save without the required field 1061 being saved
