/**
* HCmsEditorElement.js - configuration dialog for css and cardinal properties,
...
element editor
    ...
    appearance cfg (width/height,border/shadow,background,overflow,spacing)
    direct edit (css, classes, html)
...
function HCmsEditorElement( element_cfg, _layout_content, _layout_container, $container, _pageEditor, main_callback, already_changed ){
    ...
    let pageEditor; //parent page editor
    let element;
    let l_cfg, //copy of json config
        widget_cfg; //WidgetCfg object
    let codeEditor = null,   //CodeMirror
        codeEditorDlg = null,
        codeEditorBtns = null;
    let textAreaCss;
    ...
    //
    //
    function _cleanGridFlexItems(cont)
    {
    ...
    //
    //
    function _initControlsForLayoutType(){
...
console.log( 'assign', css );            
    ...
    function _initCodeEditor() {
        ...
        if(window.hWin.website_languages && window.hWin.website_languages!=''){
