...
<?php        
    ...
    if($page_footer==null){
        $is_page_footer_fixed = false;
        $page_footer = '';
    }else{
        $page_footer = '<div class="page-footer ent_footer"' //.($is_page_footer_fixed?'ent_footer':'').'"'  
            .' style="height:80px;border-top:2px solid rgb(112,146,190);background:lightgray;">'
            .$page_footer
            
            .'<div id="main-host" style="position:absolute;top:40;right:10;" class=" header-element">'
            .'<div id="host_info" style="float:right;line-height:38px;height:40px;margin-right: 0px;"></div>'
            .'<div style="float:right;padding:0 10px;height:40px;line-height: 38px;">'
            .'<a href="http://HeuristNetwork.org" target="_blank" style="text-decoration:none;" '  
            .'title="This website is generated by Heurist, an academic knowledge management system developed at the University of Sydney Faculty of Arts and Social Sciences under the direction of Dr Ian Johnson, chief programmer Artem Osmakov.">'
                .'powered by <img src="'.HEURIST_BASE_URL.'hclient/assets/h4_icon_16x16.png" style="vertical-align:sub"> Heurist'
            .'</a></div></div>'
