        ...
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#bor-navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="fa fa-bars"></span>
                </button>
                <a class="navbar-brand bor-sydney-logo"
                    href="javascript:window.loadPageContent(<?php print $home_page_record_id; ?>)">
                    Beyond 1939</a>
            </div>
        ...
        <footer class="bor-footer">
            ...
            <div class="bor-sponsors">
                ...
                <div>
                    ...
                    <img class="bor-sponsors-logo"
                        src="hclient/widgets/expertnation/assets/beyond1914/images/common/sponsors/SAC.png"
                        alt="Saint Andrew's College">
                    <img class="bor-sponsors-logo"
                        src="hclient/widgets/expertnation/assets/beyond1914/images/common/sponsors/StJohns.png"
                        alt="St John's College">
                    <img class="bor-sponsors-logo"
                        src="hclient/widgets/expertnation/assets/beyond1914/images/common/sponsors/st-pauls-college.png"
                        alt="Saint Paul's College">
                    <img class="bor-sponsors-logo"
                        src="hclient/widgets/expertnation/assets/beyond1914/images/common/sponsors/WC.png"
                        alt="The Women's College">
                </div>
            </div>
