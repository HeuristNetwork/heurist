...
$.widget( "heurist.about", {
    ...
    _create: function() {
        ...
        $("<div>").css({'font-size':'1.6em', 'font-style':'italic'}).text(window.hWin.HAPI4.database).appendTo( this.div_dbname );
        $("<div>").css({'font-size':'0.8em'}).text("v"+window.hWin.HAPI4.sysinfo.version).appendTo( this.div_dbname );
