    ...
    _create: function() {
        ...
        this.divMainMenu = $('<div>')
          ...
          function(){ 
                ...
                //that.divMainMenu.find('.ui-heurist-header');
                //    .css({'text-align':'center',padding:'10px 0px',left:0,right:0, position:'absolute'});//,height:'37px'
            ...
            if($(e.target).hasClass('ui-heurist-'+section)){
                ...
                if(!that.menues[section]){
                    ...
                    if(section=='explore'){
                        ...
                        window.hWin.HAPI4.LayoutMgr.appInitAll('SearchAnalyze2', that.menues[section] );
                        ...
                        .load(
                            ...
                            function(){ 
                                that.menues[section].find('.ui-icon')
                                    .addClass('ui-heurist-title').css({cursor:'pointer'});
