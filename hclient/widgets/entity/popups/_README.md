# Directory: /hclient/widgets/entity/popups
...
-   **manageDefTermsCorrect.html**: HTML template for the term correction popup.
-   **manageDefTermsMerge.html**: HTML template for the term merging popup.
-   **rectypeTemplate.html**: HTML template for the record type template download popup.
