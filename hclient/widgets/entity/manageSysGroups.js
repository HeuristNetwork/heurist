...
$.widget( "heurist.manageSysGroups", {
    ...
    options: {
        ...
        selectbutton_label: 'Select Marked Groups',
    ...
    _default_btn_actions:[{key:'add', title:'Add New Group'}],
        ...
        this.recordList = $('<div>')
            ...
            .resultList({
               ...
               empty_remark: 
                    ...
                    ?'<div style="padding:1em 0 1em 0">Please use the search field above to locate relevant group (partial string match on title)</div>'
                    :'',
    ...
    */
    ...
    _rendererListHeader:function(){
        //return fld2('ugr_ID','4em')+fld2('ugr_Name','10em')+fld2('ugr_Description','10em');    
    },
            ...
            var $dlg = this.element.dialog({
                ...
                title: options['title']
                            ...
                            :((options['select_mode']=='manager')
                                    ?top.HR("Manage Groups")
                                    :top.HR("Select Group"+(options['select_mode']=='select_multi'?'s':'') )),
