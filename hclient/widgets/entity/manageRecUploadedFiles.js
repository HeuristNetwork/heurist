        ...
        if(this._additionMode=='any' ||  this._additionMode=='tiled'){ //uncertain addition show both upload and url
          //only addition
                ...
                if(this._additionMode=='tiled'){
                    this.options.entity.fields[i_url_ext].dtFields['rst_DisplayHelpText'] =
                   'Upload a tile stack generated by a tiling program such as MapTiler, MapWarper. <br/>'
    +'The tile stack must be uploaded as a zip file, which cannot exceed the size limit for uploaded files. <br/>'
    +'If you require a larger tile stack please consult the Heurist team.';
                }
            ...
            this._editing_uploadfile.initEditForm([                {
                    ...
                    "dtFields":{
                        ...
                        "rst_FieldConfig":{"entity":"recUploadedFiles", "registerAtOnce":1, 
                                        "tiledImageStack":this._additionMode=='tiled'?1:0},
                        "dty_Role":"virtual",
                        "rst_Display":"hidden"
                    }
                }], null);
