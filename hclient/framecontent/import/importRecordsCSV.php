    ...
    <div style="width:100%; height:100%;" id="divStep1">
        <div class="ent_header" style="height:28em;padding:20px;">
            ...
            <div id="btnUploadData"
                title="Upload content of text area below and use it as source for CSV/TSV import operation">Upload Data</div>
        </div>
            ...
            <div>
                ...
                <div class="input-cell">
                    ...
                    <div class="heurist-helper1" style="display: block;padding-top:0.5em">
                        The creation of the primary record type from rows in the input file depends on the prior identification of other entities which will be connected via pointer fields or relationships. The tree below shows the dependencies of the primary record type determined from its pointer and relationship marker fields. Where an input entity matches an existing record, its ID value will be recorded in an ID field which can be used subsequently as a pointer field value; where no existing record is matched a new record is created and the new ID recorded. Record types connected to the primary record type by Required fields are checked automatically.<br><br>
                        Check record types to be imported. <span style="color:red">Red</span> indicates pointer fields which are Required if the corresponding record type is to be imported.
                    </div>
                </div>        
            </div>                    
            <div>
