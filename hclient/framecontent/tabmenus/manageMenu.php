            ...
            <div>
                <ul>
                    <li><a href="#" id="menu-database-browse"
                        data-nologin="1" data-logaction="db_Browse"
                    ...
                    <li><a href="admin/setup/dbcreate/createNewDB.php" name="auto-popup" class="large h3link"
                        onClick="{return false;}" data-logaction="db_New"
                    ...
                    <li class="admin-only">
                        <a href="admin/setup/dbproperties/registerDB.php" name="auto-popup" class="portrait h3link"
                            onclick= "{return false;}" data-logaction="db_Register"
                ...
                <ul>
                    ...
                    <li>
                        <a href="admin/structure/rectypes/manageRectypes.php" name="auto-popup" class="h3link active-link"
                            onClick="{return false;}" data-logaction="st_Manage"
                    ...
                    <li>
                        <a href="admin/verification/recalcTitlesAllRecords.php" name="auto-popup" class="verylarge h3link"
                            data-logaction="st_RebuildTitles"
                            onClick="{return false;}"
