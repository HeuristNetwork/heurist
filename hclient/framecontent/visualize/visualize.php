...
?>
<!-- Network diagram HTML -->
<div class="ent_header" style="height:4em;border:none;display:table-row;top:5px;">
...
?>
<div id="toolbar" class="split_bar">
    <ul class="split_bar">
    ...
    <ul class="split_bar">
        <div class="dropdown3" style="position: absolute;left: 250px;top:10px;">
            ...
            <div class="dropdown-content3">
                ...
                <div>
                    <button id="resetbutton" name="reset" onclick="refreshButton();">Refresh Data</button>
                    <button type="button" id="windowPopOut" onclick="openWin();">Open Fullscreen</button>
            ...
            <div id="setDivLabels" style="display:none; padding-left: 10px; min-width:140px;">
                ...
                <input id="textLength" title="Labels Length" class="number-input medium" type="number" min="50"
                    max="250" step="10" />
                x
                <input id="fontSize" title="Font Size" class="number-input small" type="number" min="8" max="25"
                    step="1" />
            </div>
        </div>
    </ul>
