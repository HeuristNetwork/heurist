...
regional['en'] = {
    ...
    'record_action_extract_pdf':'This function finds and parses assosiated to record pdf file, extract text and put it into specified field.<br>By default text will be assigned to "Extracted text" (2-652)',
