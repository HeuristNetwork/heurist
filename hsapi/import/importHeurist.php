...
public static function importRecords($filename, $session_id, $is_cms_init=false){
    ...
    if($data!=null){
        ...
        if($is_cms_init){
            ...
            $value_cms_info = <<<'EOD'
<p>-----</p>
<p>This is default content generated by the CMS function of the Heurist data management system (<a title="Heurist Academic Knowledge Management System" href="http://HeuristScholar.org" target="_blank" rel="noopener">HeuristScholar.org</a>).</p>
