...
'jpg,jpeg,jfif,sid,png,gif,tif,tiff,bmp,rgb,doc,docx,odt,xsl,xslx,mp3,mp4,mpeg,avi,wmv,wmz,aif,aiff,pdf,mbtiles,'
.'mid,midi,wms,wmd,qt,evo,cda,wav,csv,tsv,tab,txt,rtf,xml,xsl,xslt,hml,kml,kmz,shp,dbf,shx,htm,html,xhtml,ppt,pptx,zip,gzip,tar,json');
