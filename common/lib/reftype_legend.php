...
<div><img src="../img/rss_feed_add.gif" height=12 width=12>&nbsp;Add live bookmark</div>
     <!-- <div><img src="../../pix/home_favourite.gif">&nbsp;Favourite search</div> -->
     <div><img src="../img/edit_pencil_16x16.gif">&nbsp;Edit the reference</div>
     <div><img src="../img/follow_links_16x16.gif">&nbsp;Detail/tools</div>
     <!-- <div><img src="../external_link_16x16.gif">&nbsp;Open in new window</div> -->
     <div><img src="../img/key.gif">&nbsp;Password reminder</div>
...
?>
     <div><img src="../img/reftype/<?= $row[0] ?>.gif">&nbsp;<?= htmlspecialchars($row[1]) ?></div>
<?php
	}
?>
  </p>
