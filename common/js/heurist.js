...
if (! document.body) {
	...
	throw document.location.href + ": include heurist.js in the body, not the head";
}
...
top.HEURIST = {
	...
	basePath: top.location.pathname.replace(/(((admin|common|data|external|hapi|help|import|interface|output|search|tools|user)\/.*)|(index.*))/, ""),
