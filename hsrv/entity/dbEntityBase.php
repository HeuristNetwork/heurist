...
class DbEntityBase
{
    ...
    */
    ...
    private function _readConfig(){
        ...
        $entity_file = HEURIST_DIR.'hsrv/entity/'.lcfirst(@$this->data['entity']).'.json';
        ...
        if(file_exists($entity_file)){
           ...
           $this->system->addError(HEURIST_SYSTEM_FATAL, 'Cannot find configuration for entity '.@$this->data['entity'].' in '.HEURIST_DIR.'hsrv/entity/');     
        }
    }
    ...
    private function _readConfigLocale( $locale='en' ){
        ...
        $entity_file = HEURIST_DIR.'hsrv/entity/'.lcfirst(@$this->data['entity'])
