...
RewriteRule ^/heurist/api/(.*)$ /heurist/hsrv/controller/api.php
...
if (@$requestUri[3]=='iiif') {
    ...
    if($method=='search'){
        ...
        include_once '../../hsrv/controller/iiif_presentation.php';
    }else{
        exitWithError('Method Not Allowed', 405);
    }
...
else
{
    ...
    if($_REQUEST['entity']=='Records'){
        if($method=='search'){
            include_once '../../hsrv/controller/record_output.php';
        }else{
            exitWithError('Method Not Allowed', 405);
        }
    }else{
        include_once '../../hsrv/controller/entityScrud.php';
    }
}
exit;
