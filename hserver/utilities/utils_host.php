...
//echo "3>>> ".$host_params['heurist_dir']."\n";
        ...
        if($matches){
            ...
            $topdirs = 'admin|api|applications|common|context_help|export|hapi|hclient|hserver|import|startup|records|redirects|search|viewers|help|ext|external'; // Upddate in 3 places if changed
