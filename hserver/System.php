...
class System {
    ...
    */
    ...
    private function getInstallPath(){
        ...
        $topDirs = "admin|applications|common|context_help|export|ext|external|hapi|hclient|hserver|help|import|records|redirects|search|viewers"; // Upddate in 3 places if changed
