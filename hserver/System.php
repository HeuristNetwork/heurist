...
class System {
    ...
    */
    ...
    public function initPathConstants($dbname=null){
        ...
        define('HEURIST_RTY_ICON', HEURIST_BASE_URL.'?db='.$dbname.'&icon='); //redirected to hserver/controller/fileGet.php
    ...
    private function getInstallPath(){
        ...
        $topDirs = "admin|api|applications|common|context_help|export|hapi|hclient|hserver|import|records|redirects|search|viewers|help|ext|external"; // Upddate in 3 places if changed
