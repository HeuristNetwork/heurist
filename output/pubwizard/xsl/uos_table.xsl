...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <html>
            ...
            <body>
                <table width="100%" cellpadding="20">
                    <xsl:apply-templates select="export/references"/>
                </table>
            </body>
        </html>
    </xsl:template>
    ...
    <xsl:template match="references">
        ...
        <xsl:apply-templates select="reference" mode="sem1-junior"/>
        ...
        <xsl:apply-templates select="reference" mode="sem1-senior"/>
        ...
        <xsl:apply-templates select="reference" mode="sem1-advanced"/>
        ...
        <xsl:apply-templates select="reference" mode="sem1-honours"/>
        ...
        <xsl:apply-templates select="reference" mode="sem2-junior"/>
        ...
        <xsl:apply-templates select="reference" mode="sem2-senior"/>
        ...
        <xsl:apply-templates select="reference" mode="sem2-advanced"/>
        ...
        <xsl:apply-templates select="reference" mode="sem2-honours"/>


    </xsl:template>


    <xsl:template match="reference" mode="sem1-junior">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem1-senior">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem1-advanced">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem1-honours">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem2-junior">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem2-senior">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem2-advanced">
        <xsl:choose>
            <xsl:when
    ...
    <xsl:template match="reference" mode="sem2-honours">
        <xsl:choose>
            <xsl:when
