...
if (mysql_num_rows($res) == 0) {
	/* full steam ahead */
	mysql_query("insert into usrBookmarks (pers_rec_id, pers_usr_id, bkm_Added, bkm_Modified) values (" . $rec_id . ", " . get_user_id() . ", now(), now())");
...
$record = array(
	...
	"passwordReminder" => $bkmk["pers_pwd_reminder"],
