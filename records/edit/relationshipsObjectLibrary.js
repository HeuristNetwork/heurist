...
if (!top.Relationship) {
    top.Relationship = function(parentElement, relationshipRec, manager) {
        ...
        */
        ...
        deleteTd.appendChild(this.document.createElement("img")).src = top.HEURIST.baseURL + "common/images/cross.png";
        ...
        editTd.appendChild(this.document.createElement("img")).src = top.HEURIST.baseURL + "common/images/edit-pencil.png";
        ...
        top.HEURIST.registerEvent(ViewRec, "click", function() {
            ...
            if( recID && !isNaN(Number(recID)) ){
                ...
                var url = top.HEURIST.baseURL +"records/view/renderRecordData.php?recID=" + recID  +
    ...
    */
    top.Relationship.prototype.edit = function() {
        ...
        top.HEURIST.util.popupURL(window, top.HEURIST.baseURL + "records/edit/formEditRecordPopup.html?recID="+this.relationshipRec.relnID +
            "&db="+_db,
            {	width: 940,
                height: 640,
                callback: function(newRecTitle, newDetails) {
                    ...
                    if (newDetails) {
                        ...
                        var sURL  = top.HEURIST.baseURL + "common/php/loadRecordData.php";
    ...
    top.Relationship.prototype.editRelatedRecord = function() {
        ...
        if( thisRef.relationshipRec.relatedRec.recID ){
            window.open(top.HEURIST.baseURL +"records/edit/editRecord.html?recID=" + thisRef.relationshipRec.relatedRec.recID + "&db="+_db);
    ...
    top.EditableRelationship = function(parentElement, relationshipRec, rectypes, dtID, manager) {
        ...
        */
        ...
        optionalLinkImg.src = top.HEURIST.baseURL +"common/images/"+((isvisible)?"tdown":"tright")+".gif";

        optionalLink.onclick = function(opt)
        { return function() {
            if(opt.style.display == "block"){
                optionalLinkImg.src = top.HEURIST.baseURL +"common/images/tright.gif";
                opt.style.display = "none";
            }else{
                opt.style.display = "block";
                optionalLinkImg.src = top.HEURIST.baseURL +"common/images/tdown.gif";
            }
    ...
    top.EditableRelationship.prototype.save = function() {
        ...
        var fakeForm = { action: top.HEURIST.baseURL +"records/relationships/saveRelationships.php",
            elements: [
    ...
    */
    top.RelationManager = function(parentElement, record, relatedRecords, dtIDRelmarker, 
        ...
        addImg.src = top.HEURIST.baseURL +"common/images/add-record-small.png";
