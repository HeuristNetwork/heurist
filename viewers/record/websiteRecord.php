...
<body>
    ...
    <div id="main-header" class="ent_header" style="background:rgb(112,146,190);height:140px">
        ...
        <div id="main-title" style="float:left;padding: 35px 0 0 20px;vertical-align:middle;">
            ...
            <div id="host_info" style="float:right;background: white;vertical-align: middle;height:40px;">
            </div>
            <div style="float:right;background: white;padding: 10px;line-height: 20px;margin-right: 1px">
