<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 last updated 10/09/2007 ms
  ...
  <xsl:template match="/">
    ...
    <xsl:comment>
      <!-- name (desc.) that will appear in dropdown list --> [name]Details (compact format)[/name]
      <!-- match the name of the stylesheet--> [output]pub_details-compact[/output] </xsl:comment>
    <!-- end including code -->
  ...
  <xsl:template name="header">
    <tr>
      <td colspan="2" style="font-size: 11px; font-weight: bold;">
        <img src="{$hBase}common/images/rectype-icons/{type/@id}.png" >
