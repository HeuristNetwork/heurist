    ...
    <xsl:template match="reference">
        ...
        <xsl:element name="tr">
            ...
            <td>
                ...
                <p>[<a href="{$hBase}records/viewrec/view.php?bib_id={id}" target="_blank"><xsl:value-of select="id"/></a>] [<a href="{$hBase}records/editrec/heurist-edit.html?bkmk_id={id}" target="_blank">edit</a>]</p>
            </td>
            <td>
