<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    ...
    <xsl:comment>
      <!-- name (desc.) that will appear in dropdown list --> [name]Harvard style bibliography hml[/name]
      <!-- match the filename of the stylesheet--> [output]harvard[/output] </xsl:comment>
    <!-- end including code -->
    <html>
      <head>
