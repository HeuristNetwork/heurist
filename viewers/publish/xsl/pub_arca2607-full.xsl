<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
   ...
   <xsl:comment>
			...
			[name]ARCA 2607 with full descriptions[/name]
			<!-- match the name of the stylesheet-->
			[output]pub_arca2607-full[/output]
		</xsl:comment>
    <!-- end including code -->
    <html>
      <head>
    ...
    <tr>
      <td>
        ...
        <xsl:if test="detail[@id='160']">
          ...
          <xsl:if test="detail[@id = 228]/record/detail[@id = 229]/record"> &#160;<xsl:apply-templates
    ...
    <tr>
      <td>
        ...
        <xsl:if test="detail[@id='160']">
          ...
          <xsl:apply-templates select="detail[@id=227]/record/detail[@id=158]/record" mode="creator"/>(ed.)
      ...
      <td>
        ...
        <xsl:if test="detail[@id='160'] and url[.!='']">
          ...
          <xsl:if test="detail[@id = '158']/record">
            &#xa0;<xsl:apply-templates select="detail[@id=158]/record" mode="creator"/></xsl:if>
          <!-- abstract -->
    ...
    <tr>
      <td>
        ...
        <xsl:if test="detail[@id=229]/record">
          <!--publisher reference --> to <xsl:apply-templates select="detail/record[@id=229]"/>
        </xsl:if>
        <xsl:if test="detail[@id=187]">
          &#160;<xsl:value-of select="detail[@id=187]/@type"/>: <xsl:value-of select="detail[@id=187]"/>.
        </xsl:if>
