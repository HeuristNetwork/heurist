...
foreach ($bibIDs as $bibID) {
	...
	$res = mysql_query("select a.dtl_Value, b.dtl_Value, rec_URL, c.dtl_UploadedFileID,d.dtl_UploadedFileID,e.dtl_UploadedFileID,f.dtl_UploadedFileID, g.dtl_Value, h.dtl_Value, i.dtl_UploadedFileID
					 ...
					 left join recDetails g on g.dtl_RecID=rec_ID and g.dtl_DetailTypeID=588
					 left join recDetails h on h.dtl_RecID=rec_ID and h.dtl_DetailTypeID=551
					 left join recDetails i on i.dtl_RecID=rec_ID and i.dtl_DetailTypeID=552
						 where rec_ID=$bibID");
...
$res = mysql_query("select rec_ID, a.dtl_Value as title,
		...
		e.dtl_Value as min_zoom, f.dtl_Value as max_zoom, g.dtl_Value as copyright
						  from Records
					 left join recDetails a on a.dtl_RecID=rec_ID and a.dtl_DetailTypeID=173
					 left join recDetails b on b.dtl_RecID=rec_ID and b.dtl_DetailTypeID=585
					 left join recDetails c on c.dtl_RecID=rec_ID and c.dtl_DetailTypeID=339
					 left join recDetails d on d.dtl_RecID=rec_ID and d.dtl_DetailTypeID=289
					 left join recDetails e on e.dtl_RecID=rec_ID and e.dtl_DetailTypeID=586
					 left join recDetails f on f.dtl_RecID=rec_ID and f.dtl_DetailTypeID=587
					 left join recDetails g on g.dtl_RecID=rec_ID and g.dtl_DetailTypeID=331
