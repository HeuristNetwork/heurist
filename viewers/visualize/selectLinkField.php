...
*
* @fileOverview This PHP file generates the HTML structure and includes the necessary JavaScript
* (`selectLinkField.js`) for the dialog that allows users to define a new link
* (either a record pointer or a relationship marker) between two record types in the
* Heurist database structure visualization.
...
<script type="text/javascript">
     ...
     * If successful, it initializes the SelectLinkField functionality.
