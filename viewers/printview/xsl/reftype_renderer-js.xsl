...
document.writeln("	<tr>");
document.writeln("		<td><img><xsl:attribute name="src">http://heuristscholar.org/rectype/<xsl:value-of select="type/@id"/>.gif</xsl:attribute></img></td>");
document.writeln('		<td style="font-weight: bold;"><xsl:value-of select="title"/></td>');
document.writeln("	</tr>");
document.writeln("	<tr>");
document.writeln("		<td><nobr>Reference type</nobr></td>");
document.writeln("		<td><xsl:value-of select="type"/></td>");
document.writeln("	</tr>");
	<xsl:if test="url != ''">
document.writeln("		<tr>");
