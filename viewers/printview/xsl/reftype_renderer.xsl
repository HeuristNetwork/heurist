					...
					<xsl:choose>
						...
						<xsl:when test="string(number($arg)) = 'NaN'">
							<xsl:apply-templates select="hml/records/record">
								...
								<!-- <xsl:with-param name="year" select="/hml/dateStamp/year"/> -->
								<!-- <xsl:with-param name="month" select="/hml/dateStamp/month"/> -->
								<!-- <xsl:with-param name="day" select="/hml/dateStamp/day"/> -->
