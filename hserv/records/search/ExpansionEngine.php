...
require_once dirname(__FILE__).'/ExpansionTypes.php';
require_once dirname(__FILE__).'/ExpansionRuleParser.php';
require_once dirname(__FILE__).'/RecordSearchService.php';
...
final class ExpansionEngine
{
    ...
    public function __construct(
        ...
        $this->search = $search ?? new RecordSearchService($system);
