<?php
/**
* ExportRecordsGEOJSON.php - Class ExportRecordsGEOJSON
*
* Extends `ExportRecords` for exporting in GeoJSON format.
* 
                    ...
                    if(!isEmptyArray($_geofields)){
                        ...
                        foreach($_geofields as $idx=>$code){
                            if($code=='all'){
                                ...
                                // Legacy client format: either a direct detail id or a
                                // pre-built query for a detail on linked records.
                                if(!@$code['q']){
