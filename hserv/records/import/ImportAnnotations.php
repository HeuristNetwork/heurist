...
class ImportAnnotations{
    ...
    {
        // Annotation overlay mode assumes IIIF Presentation API v3 Canvas.annotations
        // and emits a Heurist v3 overlay Manifest.  Presentation API v2 Manifests
        // use sequences/canvases/otherContent, so importing them as overlay would
        // create records that cannot be safely re-emitted as a v3 overlay Manifest.
        // Import v2 manifests only in managed mode, where canvases are converted
        // to RT_IIIF_CANVAS records and the output is generated by Heurist.
