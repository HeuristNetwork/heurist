...
*/        
        ...
        $header_tpl = array(
            ...
            'logoAlt'=>$this->getFile($this->siteRecord, '2-926'), //, (HEURIST_BASE_URL.'hclient/assets/v6/logo.png')),
            ...
            'showLogin'=>'block',
            'showPageTitle'=>$this->getVal('99-952'),
            'pageTitle'=>'',
        ...
        $header_tpl['showLogin']=$val==TRM_NO?'none':'block';
            
        list($host_logo, $host_url) = USystem::getHostLogoAndUrl();
        if($host_logo){
            $header_tpl['hostInfo'] = '<a href="'.($host_url??'#')
