    ...
    public static function sanitizeString($message, $allowed_tags=null, $allowed_entities=true){
        if($message==null){
            ...
            if($allowed_tags==null) {
                $allowed_tags = '<a><u><i><div><em><b><strong><sup><sub><small><br><h1><h2><h3><h4><h5><h6><p><ul><li><img><blockquote><pre><span><bibl><persName><figure><figcaption><audio><video><source>';
