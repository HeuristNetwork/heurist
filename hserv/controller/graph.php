<?php
/**
* graph.php - Internal modern graph-document entry point
*
* Provides the non-OpenAPI HTTP entry point for the graph engine. It accepts the
* same request contract and returns the same response as /api/{db}/graph.
*
