var path = (HAPI && HAPI.HeuristBaseURL ? HAPI.HeuristBaseURL : (window.HeuristBaseURL ? window.HeuristBaseURL : (window.opener.HeuristBaseURL? window.opener.HeuristBaseURL: (window.opener.HAPI.HeuristBaseURL? window.opener.HAPI.HeuristBaseURL: "../../../"))));
