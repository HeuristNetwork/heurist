	  ...
	  var html ="";
		if (!isEmpty(detail)){
		  for (i in detail){
            ...
            html += "<div class=\"inp-div\"><input type=text  name=\""+id+"\" id=\""+id+"\" value=\""+theDate+"\">&nbsp<img src=\""+path+"/img/calendar.gif\" id=\"calendar"+id+"\" onclick=\"window.open('calendar.html?id="+id+"','mywin','width=300, height=150, resizable=no');\"></div>"; 
		  }
		}else{ 
		  html += "<div class=\"inp-div\"><input type=text  name=\""+id+"\" id=\""+id+"\" value=\"\">&nbsp<img src=\""+path+"/img/calendar.gif\" id=\"calendar"+id+"\" onclick=\"window.open('calendar.html?id="+id+"','mywin','width=300, height=150, resizable=no');\"></div>"; 
		}
	  sel.innerHTML += html;
	}
