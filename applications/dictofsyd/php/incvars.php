...
*
* IMPORTANT! Location must be specified explicitely in
* $urlbase_absolute and $urlbase
*
...
$urlbase_absolute = DOMAIN."h3-ao/applications/dictofsyd/";
$urlbase = DOMAIN."h3-ao/applications/dictofsyd/";
$is_generation = false;
...
define('HEURIST_DBSERVER_NAME', 'sylvester.acl.arts.usyd.edu.au:3306');
define('HEURIST_DBNAME', 'dos_3');
define('READONLY_DBUSERNAME', 'root');
define('READONLY_DBUSERPSWD', 'smith18');
//define('READONLY_DBUSERNAME', 'readonly');
//define('READONLY_DBUSERPSWD', 'readonlypwd');

define('HEURIST_THUMB_DIR', '/var/www/htdocs/HEURIST_FILESTORE/' . HEURIST_DBNAME . '/filethumbs/');
define('HEURIST_THUMB_BASE_URL', DOMAIN.'HEURIST_FILESTORE/' . HEURIST_DBNAME . '/filethumbs/');
//define('DOS_FILES', DOMAIN.'uploaded-heurist-files/dos/');
